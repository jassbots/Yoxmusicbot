...
# Get Your repo
REPO_LINK = getenv("REPO_LINK" , "https://graph.org/file/1dcf9a3ba856b765997a3.mp4")
...
# Get this value from @MusiicYo_bot on Telegram by /id
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/jassbots/Yoxmusicbot",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/33ec607dffac504ea552d.jpg"
)
PING_IMG_URL = getenv(
